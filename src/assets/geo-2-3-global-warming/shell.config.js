...
export default {
  ...
  activities: [
    ...
    },
    {
      ...
      purpose:      'Examine each natural factor in turn. For each one, consider: is there a physical mechanism that could produce sustained warming? Does the timing of this factor\'s changes match the warming pattern? Is the magnitude of its effect large enough to matter?',
    ...
    },
    {
      ...
      sentenceStarters: [
        'The evidence that most influenced my thinking was… because…',
        'When I compare natural and anthropogenic factors across all three criteria…',
        'My overall verdict is… and the evidence that best supports this is…',
        'One thing that remains uncertain is… which matters because…',
        'Before this inquiry I thought… but after examining the evidence I now think…',
      ],
      evidenceSections: [
        { id: 's-comparison',    label: 'Comparison'      },
        { id: 's-greenhouse',    label: 'Greenhouse Gases' },
