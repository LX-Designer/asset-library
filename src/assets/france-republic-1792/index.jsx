...
import {
  CHRONOLOGY, EVIDENCE_CARDS,
  FACTIONS, REFORMS, TURNING_POINTS,
  GLOSSARY, VISUAL_ASSETS,
} from './data.js'
...
// ── Lab content ───────────────────────────────────────────────────────────────
function LabContent({ openActivity, responses }) {
  return (
    <FranceCtx.Provider value={responses}>
